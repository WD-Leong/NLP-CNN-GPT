...
class MultiHeadAttention(tf.keras.layers.Layer):
    def __init__(self, d_model, n_heads, ker_sz=3):
    ...
    def __init__(
        ...
        for m in range(n_layers):
            tmp_dec_layers.append(DecoderLayer(
                n_heads, d_model, d_ffwd, ker_sz, rate1, rate2))
